...
I (79) esp_image: segment 0: paddr=00010020 vaddr=3c0a0020 size=21c3ch (138300) map

I (111) esp_image: segment 1: paddr=00031c64 vaddr=3fc9ad00 size=05850h ( 22608) load

I (116) esp_image: segment 2: paddr=000374bc vaddr=40374000 size=08b5ch ( 35676) load

I (125) esp_image: segment 3: paddr=00040020 vaddr=42000020 size=9ca90h (641680) map

I (243) esp_image: segment 4: paddr=000dcab8 vaddr=4037cb5c size=0e0c8h ( 57544) load

I (256) esp_image: segment 5: paddr=000eab88 vaddr=50000000 size=00024h (    36) load
...
I (315) MSPI Timing: Enter psram timing tuning
...
I (770) cpu_start: GPIO 44 and 43 are used as console UART I/O pins
...
I (776) app_init: Project name:     audio_node

I (780) app_init: App version:      25b6b1d-dirty

I (785) app_init: Compile time:     Sep 13 2026 18:49:52

I (790) app_init: ELF file SHA256:  ad122631c...

I (794) app_init: ESP-IDF:          v6.1
...
I (1106) wifi:new:<11,0>, old:<1,0>, ap:<255,255>, sta:<11,0>, prof:1, snd_ch_cfg:0x0

I (1116) wifi:state: init -> auth (0xb0)

I (1126) main_task: Returned from app_main()

I (1126) wifi:state: auth -> assoc (0x0)

I (1136) wifi:state: assoc -> run (0x10)

I (1256) wifi:connected with <ssid>, aid = 2, channel 11, BW20, bssid = e8:68:19:3c:f0:88

I (1256) wifi:security: WPA2-PSK, phy: bgn, rssi: -43, cipher(pairwise:0x3, group:0x1), pmf:0
...
I (1336) wifi:AP's beacon interval = 102400 us, DTIM period = 1

I (1536) wifi:<ba-add>idx:0 (ifx:0, e8:68:19:3c:f0:88), tid:0, ssn:3, winSize:64

I (4326) esp_netif_handlers: sta ip: <board-ip>, mask: 255.255.255.0, gw: 192.168.100.1
