...
I (574996) wifi:state: run -> init (0x0)

I (574996) wifi:pm stop, total sleep time: 0 us / 572565465 us



I (574996) wifi:<ba-del>idx:0, tid:0

wifi disconnected, retrying...

I (575036) wifi:flush txq

I (575036) wifi:stop sw txq

I (575036) wifi:lmac stop hw txq
...
I (125) esp_image: segment 3: paddr=00040020 vaddr=42000020 size=9db14h (645908) map

I (244) esp_image: segment 4: paddr=000ddb3c vaddr=4037c794 size=0e490h ( 58512) load
...
I (278) octal_psram: vendor id    : 0x0d (AP)

I (278) octal_psram: dev id       : 0x02 (generation 3)

I (278) octal_psram: density      : 0x03 (64 Mbit)

I (280) octal_psram: good-die     : 0x01 (Pass)

I (284) octal_psram: Latency      : 0x01 (Fixed)

I (289) octal_psram: VCC          : 0x01 (3V)

I (293) octal_psram: SRF          : 0x01 (Fast Refresh)

I (298) octal_psram: BurstType    : 0x01 (Hybrid Wrap)

I (303) octal_psram: BurstLen     : 0x01 (32 Byte)

I (307) octal_psram: Readlatency  : 0x02 (10 cycles@Fixed)

I (312) octal_psram: DriveStrength: 0x00 (1/1)

I (317) MSPI Timing: Enter psram timing tuning
...
I (763) esp_psram: SPI SRAM memory test OK
...
I (782) app_init: App version:      f97e36d-dirty

I (786) app_init: Compile time:     Sep 14 2026 22:13:31

I (791) app_init: ELF file SHA256:  878c0f43d...
...
I (811) heap_init: Initializing. RAM available for dynamic allocation:

I (817) heap_init: At 3FCA6920 len 00042DF0 (267 KiB): RAM

I (822) heap_init: At 3FCE9710 len 00005724 (21 KiB): RAM

I (827) heap_init: At 3FCF0000 len 00008000 (32 KiB): DRAM

I (833) heap_init: At 600FE000 len 00001FE8 (7 KiB): RTCRAM
...
I (864) sleep_gpio: Configure to isolate all GPIO pins in sleep state

I (870) sleep_gpio: Enable automatic switching of GPIO sleep configuration

I (877) main_task: Started on CPU0

I (877) esp_psram: Reserving pool of 32K of internal memory for DMA/internal allocations
...
I (937) wifi:wifi driver task: 3fcb7b88, prio:23, stack:6656, core=0

I (937) wifi:wifi firmware version: e12a754

I (937) wifi:wifi certification version: v7.0

I (937) wifi:config NVS flash: enabled

I (937) wifi:config nano formatting: disabled

I (947) wifi:Init data frame dynamic rx buffer num: 32

I (947) wifi:Init static rx mgmt buffer num: 5
...
I (967) wifi:Init static rx buffer size: 1600

I (967) wifi:Init static rx buffer num: 10

I (977) wifi:Init dynamic rx buffer num: 32

I (977) wifi_init: rx ba win: 6

I (977) wifi_init: accept mbox: 6

I (987) wifi_init: tcpip mbox: 32

I (987) wifi_init: udp mbox: 6

I (987) wifi_init: tcp mbox: 6

I (987) wifi_init: tcp tx win: 5760

I (997) wifi_init: tcp rx win: 5760

I (997) wifi_init: tcp mss: 1440

I (997) wifi_init: WiFi IRAM OP enabled

I (1007) wifi_init: WiFi RX IRAM OP enabled

cfg: none in NVS (first boot / factory reset)

wifi: no SSID configured, starting setup AP

I (1037) phy_init: phy_version 712,87e8c20e,Apr 13 2026,18:51:10

W (1037) phy_init: failed to load RF calibration data (0x1102), falling back to full calibration

I (1067) phy_init: Saving new calibration data due to checksum failure or outdated calibration data, mode(2)

I (1087) wifi:mode : softAP (30:30:f9:33:91:d9)
...
I (1087) esp_netif_lwip: DHCP server started on interface WIFI_AP_DEF with IP: 192.168.4.1

setup ap: running 'AudioNode-Setup' open AP, portal http://192.168.4.1/

udp: listening on 0.0.0.0:1234, waiting for RTP L16 (PT=96)...

I (1107) main_task: Returned from app_main()

factory reset: BOOT held, keep 5 s to erase NVS

factory reset: BOOT released, cancelled

I (14997) wifi:new:<1,0>, old:<1,1>, ap:<1,1>, sta:<255,255>, prof:1, snd_ch_cfg:0x0

I (15007) wifi:station: a4:c3:f0:3c:f1:7c join, AID=1, bgn, 20

I (15037) esp_netif_lwip: DHCP server assigned IP to a client, IP is: 192.168.4.2

cfg: saved via portal (SSID=<ssid> server=<pc-ip>:1234)

I (22287) wifi:station: a4:c3:f0:3c:f1:7c leave, AID = 1, reason = 2, bss_flags is 33721443, bss:0x3fca961c

I (22287) wifi:new:<1,1>, old:<1,0>, ap:<1,1>, sta:<255,255>, prof:1, snd_ch_cfg:0x0
...
I (2406) wifi:security: WPA2-PSK, phy: bgn, rssi: -33, cipher(pairwise:0x3, group:0x1), pmf:0

I (2416) wifi:pm start, type: 0



I (2416) wifi:dp: 1, bi: 102400, li: 3, scale listen interval from 307200 us to 307200 us

I (2416) wifi:set rx beacon pti, rx_bcn_pti: 0, bcn_timeout: 25000, mt_pti: 0, mt_time: 10000

I (2506) wifi:AP's beacon interval = 102400 us, DTIM period = 1

I (2726) wifi:<ba-add>idx:0 (ifx:0, e8:68:19:3c:f0:88), tid:0, ssn:2, winSize:64

I (5486) esp_netif_handlers: sta ip: <board-ip>, mask: 255.255.255.0, gw: 192.168.100.1
...
I (160956) wifi:state: run -> init (0x0)

I (160956) wifi:pm stop, total sleep time: 0 us / 158535391 us



I (160956) wifi:<ba-del>idx:0, tid:0

wifi disconnected, retrying...

I (160996) wifi:flush txq

I (160996) wifi:stop sw txq

I (160996) wifi:lmac stop hw txq
...
I (1077) wifi:mode : softAP (30:30:f9:33:91:d9)
...
I (14347) wifi:new:<1,0>, old:<1,1>, ap:<1,1>, sta:<255,255>, prof:1, snd_ch_cfg:0x0

I (14357) wifi:station: a4:c3:f0:3c:f1:7c join, AID=1, bgn, 20

I (14387) esp_netif_lwip: DHCP server assigned IP to a client, IP is: 192.168.4.2

cfg: saved via portal (SSID=<ssid> server=<pc-ip>:1234)

I (20077) wifi:station: a4:c3:f0:3c:f1:7c leave, AID = 1, reason = 2, bss_flags is 33721459, bss:0x3fca961c

I (20077) wifi:new:<1,1>, old:<1,0>, ap:<1,1>, sta:<255,255>, prof:1, snd_ch_cfg:0x0

I (20127) wifi:flush txq

I (20127) wifi:stop sw txq

I (20127) wifi:lmac stop hw txq
...
I (1096) wifi:mode : sta (30:30:f9:33:91:d8)
...
I (2276) wifi:new:<10,0>, old:<1,0>, ap:<255,255>, sta:<10,0>, prof:1, snd_ch_cfg:0x0

I (2276) wifi:state: init -> auth (0xb0)

I (2276) wifi:state: auth -> assoc (0x0)

I (2286) wifi:state: assoc -> run (0x10)

I (2446) wifi:connected with <ssid>, aid = 2, channel 10, BW20, bssid = e8:68:19:3c:f0:88

I (2446) wifi:security: WPA2-PSK, phy: bgn, rssi: -40, cipher(pairwise:0x3, group:0x1), pmf:0

I (2456) wifi:pm start, type: 0



I (2456) wifi:dp: 1, bi: 102400, li: 3, scale listen interval from 307200 us to 307200 us

I (2456) wifi:set rx beacon pti, rx_bcn_pti: 0, bcn_timeout: 25000, mt_pti: 0, mt_time: 10000

I (2526) wifi:AP's beacon interval = 102400 us, DTIM period = 1

I (3306) wifi:<ba-add>idx:0 (ifx:0, e8:68:19:3c:f0:88), tid:0, ssn:2, winSize:64

I (5516) esp_netif_handlers: sta ip: <board-ip>, mask: 255.255.255.0, gw: 192.168.100.1
...
I (38886) wifi:state: run -> init (0x0)

I (38886) wifi:pm stop, total sleep time: 0 us / 36425568 us



I (38886) wifi:<ba-del>idx:0, tid:0

wifi disconnected, retrying...

I (38916) wifi:flush txq

I (38916) wifi:stop sw txq

I (38916) wifi:lmac stop hw txq
...
I (10396) wifi:new:<1,0>, old:<1,1>, ap:<1,1>, sta:<255,255>, prof:1, snd_ch_cfg:0x0

I (10396) wifi:station: a4:c3:f0:3c:f1:7c join, AID=1, bgn, 20

I (10426) esp_netif_lwip: DHCP server assigned IP to a client, IP is: 192.168.4.2

cfg: saved via portal (SSID=<ssid>12 server=<pc-ip>:1234)

I (19116) wifi:<ba-add>idx:2 (ifx:1, a4:c3:f0:3c:f1:7c), tid:0, ssn:52, winSize:64

I (19346) wifi:station: a4:c3:f0:3c:f1:7c leave, AID = 1, reason = 2, bss_flags is 33721443, bss:0x3fca961c

I (19346) wifi:<ba-del>idx:2, tid:0

I (19346) wifi:new:<1,1>, old:<1,0>, ap:<1,1>, sta:<255,255>, prof:1, snd_ch_cfg:0x0

I (19406) wifi:flush txq

I (19406) wifi:stop sw txq

I (19406) wifi:lmac stop hw txq
...
I (1096) wifi:Set ps type: 0, coexist: 0
...
W (11096) wifi:Haven't to connect to a suitable AP now!
...
W (21096) wifi:Haven't to connect to a suitable AP now!
...
W (31096) wifi:Haven't to connect to a suitable AP now!

wifi disconnected, retrying...

failover: no IP in 30000 ms, opening setup AP (NVS kept)

I (33096) wifi:flush txq

I (33096) wifi:stop sw txq

I (33096) wifi:lmac stop hw txq

I (33106) wifi:mode : softAP (30:30:f9:33:91:d9)

I (33106) wifi:Total power save buffer number: 16

I (33106) wifi:Init max length of beacon: 752/752

I (33116) wifi:Init max length of beacon: 752/752

I (33116) esp_netif_lwip: DHCP server started on interface WIFI_AP_DEF with IP: 192.168.4.1

setup ap: running 'AudioNode-Setup' open AP, portal http://192.168.4.1/

I (47696) wifi:new:<1,0>, old:<1,1>, ap:<1,1>, sta:<255,255>, prof:1, snd_ch_cfg:0x0

I (47696) wifi:station: a4:c3:f0:3c:f1:7c join, AID=1, bgn, 20

I (47736) esp_netif_lwip: DHCP server assigned IP to a client, IP is: 192.168.4.2

I (49036) wifi:<ba-add>idx:2 (ifx:1, a4:c3:f0:3c:f1:7c), tid:0, ssn:21, winSize:64

cfg: saved via portal (SSID=<ssid> server=<pc-ip>:1234)

I (63116) wifi:station: a4:c3:f0:3c:f1:7c leave, AID = 1, reason = 2, bss_flags is 33721443, bss:0x3fcaabac

I (63116) wifi:<ba-del>idx:2, tid:0

I (63116) wifi:new:<1,1>, old:<1,0>, ap:<1,1>, sta:<255,255>, prof:1, snd_ch_cfg:0x0

I (63166) wifi:flush txq

I (63166) wifi:stop sw txq

I (63166) wifi:lmac stop hw txq
...
I (946) wifi:wifi driver task: 3fcb7ce0, prio:23, stack:6656, core=0
...
I (966) wifi:Init management short buffer num: 32
...
I (986) wifi:Init dynamic rx buffer num: 32

I (996) wifi_init: rx ba win: 6

I (996) wifi_init: accept mbox: 6

I (996) wifi_init: tcpip mbox: 32
...
W (1036) wifi:Password length matches WPA2 standards, authmode threshold changes from OPEN to WPA2

I (1066) phy_init: phy_version 712,87e8c20e,Apr 13 2026,18:51:10
...
I (2416) wifi:connected with <ssid>, aid = 2, channel 10, BW20, bssid = e8:68:19:3c:f0:88

I (2426) wifi:security: WPA2-PSK, phy: bgn, rssi: -34, cipher(pairwise:0x3, group:0x1), pmf:0

I (2436) wifi:pm start, type: 0



I (2436) wifi:dp: 1, bi: 102400, li: 3, scale listen interval from 307200 us to 307200 us

I (2436) wifi:set rx beacon pti, rx_bcn_pti: 0, bcn_timeout: 25000, mt_pti: 0, mt_time: 10000

I (2476) wifi:AP's beacon interval = 102400 us, DTIM period = 1

I (3606) wifi:<ba-add>idx:0 (ifx:0, e8:68:19:3c:f0:88), tid:0, ssn:2, winSize:64
...
udp: pkts=1 dropped=0 ring=1920 pcm=1920 bytes (t=49621 ms)

rssi=-41

udp: pkts=252 dropped=0 ring=7040 pcm=483840 bytes (t=54642 ms)
