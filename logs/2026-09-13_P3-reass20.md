...
I (785) app_init: Compile time:     Sep 13 2026 20:55:08

I (790) app_init: ELF file SHA256:  4c97fc3af...
...
I (1246) wifi:connected with <ssid>, aid = 1, channel 11, BW20, bssid = e8:68:19:3c:f0:88

I (1246) wifi:security: WPA2-PSK, phy: bgn, rssi: -45, cipher(pairwise:0x3, group:0x1), pmf:0

I (1256) wifi:pm start, type: 0



I (1256) wifi:dp: 1, bi: 102400, li: 3, scale listen interval from 307200 us to 307200 us

I (1266) wifi:set rx beacon pti, rx_bcn_pti: 0, bcn_timeout: 25000, mt_pti: 0, mt_time: 10000

I (1296) wifi:AP's beacon interval = 102400 us, DTIM period = 1

I (3326) wifi:<ba-add>idx:0 (ifx:0, e8:68:19:3c:f0:88), tid:0, ssn:2, winSize:64

I (4636) esp_netif_handlers: sta ip: <board-ip>, mask: 255.255.255.0, gw: 192.168.100.1

GOT IP: <board-ip>

rssi=-42

udp: pkts=1 dropped=0 ring=1920 pcm=1920 bytes (t=12591 ms)

udp: pkts=222 dropped=0 ring=1920 pcm=426240 bytes (t=17672 ms)

rssi=-43

udp: pkts=519 dropped=0 ring=90880 pcm=996480 bytes (t=22684 ms)

udp: pkts=769 dropped=0 ring=89600 pcm=1476480 bytes (t=27705 ms)

rssi=-42

udp: pkts=1021 dropped=0 ring=90112 pcm=1960320 bytes (t=32724 ms)

udp: pkts=1272 dropped=0 ring=90752 pcm=2442240 bytes (t=37742 ms)
